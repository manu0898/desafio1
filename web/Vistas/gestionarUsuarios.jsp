...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../css/gestionarUsuarios.css">
            ...
            <div id="tabla">
                ...
                <table>
                    ...
                    <form name="for" action="../Controladores/controlador.jsp" method="POST">
                        <tr>
                            <td><input type="text" name ="correoCrud" value='<%= paux.getCorreo()%>' readonly></td>
                            <td><input type="text" name ="nombreCrud" value='<%= paux.getNombre()%>'></td>
                            <td><input type="text" name ="apellidoCrud" value='<%= paux.getApellido()%>'></td>
                            <td><input type="number" name ="edadCrud" value='<%= paux.getEdad()%>'></td>

                            <td><input type="submit" name="modifCRUDUsuarios" value="Modificar"></td>
                            <td><input type="submit" name="elimCRUDUsuarios" value="Eliminar"></td>
                        </tr>
                    </form>
